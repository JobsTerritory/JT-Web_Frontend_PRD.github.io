  ...
  return (
    <div>
      ...
      <CustomView condition={deviceType === 'tablet'}>
        <div className="fontLink DRMtitle service-heading-tablet">GIG/FLEXIBLE HIRING</div>
        ...
        >
          <div className="row align-items-start">
            <div className="col-5" style={{ marginRight: "5vw" }}>
              <img className="ind-we-cater-icon" src={img1} style={{ marginLeft: '5vw' }}></img>
              <h5>Hire as many as you want through monthly </h5>
            </div>
            <div className="col-5" style={{ marginRight: "5vw" }}>
              <img className="ind-we-cater-icon" src={img2} style={{ marginLeft: '9vw' }}></img>
          ...
          <div className="row align-items-start">
            <div className="col-5">
              <img className="ind-we-cater-icon" src={img7} style={{ marginLeft: '7vw' }}></img>
              <h5 style={{ marginLeft: '5vw' }}>Completes all your hiring</h5>
            </div>
            <div className="col-5">
              <img className="ind-we-cater-icon" src={img3} style={{ marginLeft: '13vw' }}></img>
