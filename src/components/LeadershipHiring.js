  ...
  return (
    <div>
      ...
      <CustomView condition={deviceType === 'tablet'}>
        <div className="fontLink DRMtitle service-heading-tablet">Leadership Hiring</div>
        ...
        <div style={{ backgroundImage: `url(${bgImg})`, height: '52vw', background: 'linear-gradient(0deg, rgba(0, 0, 0, 0.62), rgba(0, 0, 0, 0.62))' }}>
          <div className="mt-40 drm-heading"
          style={{position: 'relative', left: '175px', top: '10px',marginTop: '0'}}>WHY SHOULD YOU OPT FOR IT</div>
        ...
        >
          ...
          <div className="row align-items-center">
            <div className="col-5" style={{ verticalAlign: "middle" }}>
              ...
              ></img>
              <h5 style={{marginLeft: '2vw', marginBottom: '2vw' }}>Completes all your hiring</h5>
            </div>
