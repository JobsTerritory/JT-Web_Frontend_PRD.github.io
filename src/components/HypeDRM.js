  ...
  return (
    <div className="pb-10 pt-52" style={{marginTop: '-5vw'}}>
        ...
        <div className="container fontlink" style={{ color: "#535353" }}>
          <div className="row align-items-start">
            <div className="col-5" style={{ marginRight: "5vw" }}>
              <img className="ind-we-cater-icon" src={img1} alt=""></img>
              <h6 className="int-page-pic-icons-txt"
          ...
          <div className="row align-items-start">
            ...
            <div className="col-5" style={{ marginRight: "5vw" }}>
              <img className="ind-we-cater-icon" src={img8} alt=""></img>
              <h6 className="internal-page-pic-icons-txt"
            ...
            <div className="row align-items-start">
              ...
              <div
                ...
                style={{ marginRight: "5vw", marginTop: "-2vw" }}
              >
                <img className="ind-we-cater-icon" src={img6} alt="" 
      ...
      <CustomView condition={deviceType === 'tablet'}>
        <div className="container fontlink hype-drm-tablet" style={{ color: "#535353" }}>
          <div className="row align-items-start">
            <div className="col-5" style={{ marginRight: "5vw" }}>
              <img className="ind-we-cater-icon" src={img1} alt="" 
            ...
            <div className="col-5" style={{ marginRight: "5vw" }}>
              <img className="ind-we-cater-icon" src={img2} alt=""
          ...
          <div className="row align-items-start">
            <div className="col-5" style={{ marginRight: "5vw" }}>
              <img className="ind-we-cater-icon" src={img4} alt=""
              style={{marginLeft: '12vw'}} />
              <h6 className="int-page-pic-icons-txt"
            ...
            <div className="col-5" style={{ marginRight: "5vw" }}>
              <img className="ind-we-cater-icon" src={img5} alt=""
              style={{marginLeft: '12vw'}} />
          ...
          <div className="row align-items-start">
            <div className="col-5" style={{ marginRight: "5vw" }}>
              <img className="ind-we-cater-icon" src={img7} alt=""
              style={{marginLeft: '12vw'}} />
              <h6 className="int-page-pic-icons-txt"
              style={{marginLeft: '8vw', textAlign: 'center'}}
              >
            ...
            <div className="col-5" style={{ marginRight: "5vw" }}>
              <img className="ind-we-cater-icon" src={img8} alt=""
              style={{marginLeft: '12vw'}} />
              <h6 className="internal-page-pic-icons-txt"
              style={{marginLeft: '6vw'}}
              >
            ...
            <div className="row align-items-start">
              <div className="col-5">
                <img className="ind-we-cater-icon" src={img3} alt=""
                style={{marginLeft: '12vw'}} />
                <h6 className="int-page-pic-icons-txt"
